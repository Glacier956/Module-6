...
print(name + ", ваша задолженность составляет", str(amount_debt), "рублей.")

while True:
  amount = int(input('Сколько рублей вы внесёте прямо сейчас, чтобы её погасить? '))
  if amount >= amount_debt:
